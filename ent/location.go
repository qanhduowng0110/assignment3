...
func (e LocationEdges) EarthquakesOrErr() ([]*Earthquake, error) {
	if e.loadedTypes[0] {
...
func (*Location) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case location.FieldLongitude, location.FieldLatitude, location.FieldDept:
...
// QueryEarthquakes queries the "earthquakes" edge of the Location entity.
func (l *Location) QueryEarthquakes() *EarthquakeQuery {
	return NewLocationClient(l.config).QueryEarthquakes(l)
}
...
func (l *Location) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", l.Dept))
	builder.WriteString(", ")
